...
class DisPlayer(Player):
    ...
    async def invoke_player(self, ctx: commands.Context = None) -> None:
        ...
        try:
            ...
            embed.set_thumbnail(
              url=
                "https://cdn.discordapp.com/avatars/1103575978770436116/00a122a04cfce69006223bc06eadd93d.png?size=2048"
            )
    ...
    async def create_nodes(self):
        ...
        await wavelink.NodePool.create_node(
            ...
            spotify_client=spotify.SpotifyClient(
                client_id="731ac5bf0603411f80ac446f5c02e290",
                client_secret="cd16a34c385b4fa5915abd596fd4e480"))
    ...
    async def play(self, ctx: commands.Context, *, search: str):
        ...
        if 'https://open.spotify.com' in str(search):
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                embed = discord.Embed(
                    description=
                    f'[{track}](https://discord.gg/HyWQdHjNPz) Added To The Queue',
                    color=0x2f3136)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                embed = discord.Embed(
                    description=
                    f'[{track1}](https://discord.gg/HyWQdHjNPz) Added To The Queue',
                    color=0x2f3136)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                embed = discord.Embed(
                    description=
                    f'[{track2}](https://discord.gg/HyWQdHjNPz) Added To The Queue',
                    color=0x2f3136)
    ...
    async def _queue(self, ctx):
        ...
        for song in copy:
            ...
            hacker4.add_field(name=f"Position : {count}",
                              value=f"[{song.title}](https://discord.gg/HyWQdHjNPz)")
